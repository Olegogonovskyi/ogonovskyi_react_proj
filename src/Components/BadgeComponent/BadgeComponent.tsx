...
//
// виникає помилка
// <html>TS2345: Argument of type '(string | (string | { image: string; alt: string; })[] | (string | { image: string; alt: string; url: string; title: string; })[] | (string | { left: string; right: string; alt: string; url: string; title: string; })[] | (string | { ...; })[])[]' is not assignable to parameter of type 'BadgeEntries'.<br/>Type 'string | (string | { image: string; alt: string; })[] | (string | { image: string; alt: string; url: string; title: string; })[] | (string | { left: string; right: string; alt: string; url: string; title: string; })[] | (string | { ...; })[]' is not assignable to type 'BadgeEntry'.<br/>Type '(string | { image: string; alt: string; })[]' is not assignable to type 'BadgeEntry'.<br/>Type '(string | { image: string; alt: string; })[]' is not assignable to type '[string, object]'.<br/>Target requires 2 element(s) but source may have fewer.